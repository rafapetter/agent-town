        ...
        headerExtra={
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              <a href="https://github.com/rafapetter/agent-town" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: 'var(--muted)', textDecoration: 'none' }} title="View on GitHub">
